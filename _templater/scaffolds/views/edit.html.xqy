...
<div>
    ...
    <div class="body">
        <div class="buttons">
            Edit {util:fix-camel-case-to-string("@object@")}
        </div>
        
        {
            uni-form:build-form(@object-escaped@:keys(), $@object-escaped@:@object-escaped@-constraints, "inlineLabels", fn:concat("/@object-escaped@/", @object-escaped@:id(map:get($model, '@object-escaped@')), "?method=put"), map:get($model, '@object-escaped@'))
        }
